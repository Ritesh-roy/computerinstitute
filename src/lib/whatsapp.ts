...
export const CONTACT_EMAIL = "skcomputerinstitute53@gmail.com";
export const MAP_QUERY = "SK Institute, A-818, B Block Rd, near A-BLOCK, Mangol Puri, New Delhi 110083";
